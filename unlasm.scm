...
(defmacro lib-add (nth c2))
(defmacro lib-sub (nth c3))
(defmacro lib-eq (nth c4))
(defmacro lib-lt (nth c5))
(defmacro lib-load (nth c6))
(defmacro lib-store (nth c7))
(defmacro lib-putc (nth c8))
(defmacro lib-getc (nth c9))
